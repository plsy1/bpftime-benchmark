...
└── v0.2.0/
    ...
    ├── perf/                 # reader/perf 诊断
    ├── compatibility/        # root、Boost、工具链、runtime 对照
    ├── payload-tests/        # 指定 payload 的定向测试
...
| `v0.2.0/full/docker-2x-20260712/` | v0.2.0 Docker 早期两轮日志 |
| `v0.2.0/full/docker-5x-20260713/` | v0.2.0 Docker 5 轮完整结果；`incomplete/` 为启动失败日志 |
