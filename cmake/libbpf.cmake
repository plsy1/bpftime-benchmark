...
# Patch bpftool libbpf submodule before building
execute_process(
  COMMAND python3 ${CMAKE_CURRENT_LIST_DIR}/patch_bpftool_libbpf.py
  RESULT_VARIABLE PATCH_RESULT
)
if(NOT PATCH_RESULT EQUAL 0)
  message(WARNING "Failed to patch bpftool libbpf submodule: ${PATCH_RESULT}")
endif()
