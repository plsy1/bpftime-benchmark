...
BENCH_FUNC(__ladder_setup)
BENCH_FUNC(__ladder_empty)
BENCH_FUNC(__ladder_loop_control)
BENCH_FUNC(__ladder_simple_helper)
BENCH_FUNC(__ladder_array_lookup)
BENCH_FUNC(__ladder_hash_hit)
BENCH_FUNC(__ladder_hash_miss)
...
int main(int argc, char **argv)
{
	...
	const struct bench_case cases[] = {
		{ "empty", __ladder_empty },
		{ "loop_control", __ladder_loop_control },
		{ "simple_helper", __ladder_simple_helper },
		{ "array_lookup", __ladder_array_lookup },
		{ "hash_hit", __ladder_hash_hit },
		{ "hash_miss", __ladder_hash_miss },
	};

	/* Populate both maps outside every timed interval. */
	invoke(__ladder_setup, 1);
